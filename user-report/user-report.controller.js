(function () {
    ...
    UserReportController.$inject = ['UserService', '$rootScope', '$scope', '$http', '$log', '$location', '$state'];
    function UserReportController(UserService, $rootScope, $scope, $http, $log, $location, $state) {
        var vm = this;
