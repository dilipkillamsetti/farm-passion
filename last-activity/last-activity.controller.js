(function () {
    ...
    angular
        .module('app')
        .controller('LastActivityController', LastActivityController);

    LastActivityController.$inject = ['UserService', '$rootScope', '$scope', '$http', '$log', '$location', '$state'];
    function LastActivityController(UserService, $rootScope, $scope, $http, $log, $location, $state) {
        var vm = this;
  ...
  /*              var modalInstance = $uibModal.open({
        ...
        $scope.openAccordion = function (userId) {
          ...
          $scope.accordion = true;
            ...
            $scope.searchByDayOptions = function(){
              
                var url = "http://192.168.1.123:8185/capital-backend/filterbydate.php?q="+$scope.searchBy;
                UserService.getRequest(url).then(function(response){
